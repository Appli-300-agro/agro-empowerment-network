// Catalogue de 100 produits pour Agro Empowerment Network
...
const generateProducts = () => {
  ...
  for (let i = 1; i <= 100; i++) {
    ...
    products.push({
      id: `prod-${i}`,
      name: productName,
      description: `Découvrez notre ${dishBaseName}, une solution de la catégorie ${sector} proposée par Agro Empowerment Network. Qualité garantie.`,

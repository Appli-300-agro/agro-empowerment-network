  ...
  return (
    <footer className="bg-secondary-dark text-slate-300 py-12 no-print">
      <div className="container mx-auto px-4 grid grid-cols-1 md:grid-cols-4 gap-8">
        {/* Brand */}
        <div>
          <h3 className="text-white text-lg font-heading font-bold mb-4">Agro Empowerment Network</h3>
        ...
        <div>
          ...
          <ul className="space-y-2 text-sm">
            ...
            <li>contact@agroempowermentnetwork.cm</li>
            <li>+237 671 00 08 40</li>
          </ul>
        </div>
        ...
        <div>
          ...
          <div className="flex gap-4">
            <a href="https://www.facebook.com/cassvita1" target="_blank" rel="noopener" className="hover:text-primary transition-colors"><Facebook className="w-5 h-5" /></a>
            <a href="https://wa.me/237671000840" target="_blank" rel="noopener" className="hover:text-primary transition-colors"><MessageCircle className="w-5 h-5" /></a>
          </div>
        </div>
      </div>
      <div className="border-t border-slate-700 mt-12 pt-8 text-center text-xs">
        © {new Date().getFullYear()} Agro Empowerment Network. Tous droits réservés.
      </div>
    </footer>
  );
};

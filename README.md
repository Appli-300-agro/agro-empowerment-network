# Agro Empowerment Network - Plateforme Web E-commerce

Bienvenue sur le dépôt du code source de l'application web **Agro Empowerment Network**. Ce projet est une solution complète (Site Vitrine + E-commerce + Administration) développée avec des technologies modernes pour assurer performance et évolutivité.
...
| :--- | :--- | :--- | :--- |
| **Administrateur** | `admin@agroempowermentnetwork.cm` | `admin123` | **OTP : 2025** |
| **Utilisateur** | `user@agroempowermentnetwork.cm` | `user123` | |
...
*   **Contact :** contact@agroempowermentnetwork.cm